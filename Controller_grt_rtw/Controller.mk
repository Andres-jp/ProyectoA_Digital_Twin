...
## Generated on : Fri Mar 20 20:01:32 2026
...
START_DIR                 = C:/Users/Andres/MATLAB/Projects/Proyecto_Digital_Twin
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
DEFINES_STANDARD = -DMODEL=Controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/Controller_grt_rtw/Controller.c $(START_DIR)/Controller_grt_rtw/rtGetInf.c $(START_DIR)/Controller_grt_rtw/rtGetNaN.c $(START_DIR)/Controller_grt_rtw/rt_nonfinite.c
...
OBJS = rt_logging.obj Controller.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
%.obj : $(START_DIR)/Controller_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/Controller_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controller.obj : $(START_DIR)/Controller_grt_rtw/Controller.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetInf.obj : $(START_DIR)/Controller_grt_rtw/rtGetInf.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rtGetNaN.obj : $(START_DIR)/Controller_grt_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) -o "$@" "$<"


rt_nonfinite.obj : $(START_DIR)/Controller_grt_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) -o "$@" "$<"
